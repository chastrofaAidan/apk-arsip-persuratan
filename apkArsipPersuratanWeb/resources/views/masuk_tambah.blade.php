...
<div class="px-3 py-2 bg-white rounded shadow">
    <h4 class="fw-bold">
        <i class="ri-git-repository-line sidebar-menu-item-icon" style="font-size: 20px;"></i>
        Pendataan Surat Masuk
    </h4>
    <hr>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input class="custom-input" type="text" name="identitas_masuk" id="identitas_masuk" required="required"  value="{{ \Carbon\Carbon::now()->format('j F Y') }}"><br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
