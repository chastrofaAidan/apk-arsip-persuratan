...
<table class="table table-bordered table-striped" border="1">
    ...
    <tr>
        ...
        <td>
            <a href="{{ asset('preview/' . $k->surat_keluar) }}" class="btn col-12 text-center" target="_blank" style="background-color: var(--bs-color2); color: white;">
                <i class="ri-eye-line"></i>
            </a><br><br>
            <a href="{{ asset('preview/' . $k->surat_keluar) }}" class="btn col-12 text-center" style="background-color: var(--bs-color1); color: white;" download>
        ...
        <td>
            <a href="/surat_keluar/edit/{{ $k->no_keluar }}" class="btn col-12 text-center" style="background-color: var(--bs-color2); color: white;">
            <i class="ri-edit-box-line"></i>
            </a><br><br>
            <a href="/surat_keluar/hapus/{{ $k->no_keluar }} " class="btn col-12 text-center" style="background-color: var(--bs-color1); color: white;">
