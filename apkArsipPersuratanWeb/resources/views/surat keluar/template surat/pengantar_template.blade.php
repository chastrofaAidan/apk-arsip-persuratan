...
<div class="px-3 py-2 bg-white rounded shadow">
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            <input class="custom-input" type="text" name="surat_keluar" id="surat_keluar" required="required" placeholder="Tidak Mengandung Spasi / Karakter Spesial"><br><br>
        </div>
        <!-- <div class="col-12">
        ...
        <div class="container">
            ...
            <div style="text-align: center;"><b style="font-size: 19px;"><u>S U R A T &nbsp; P E N G A N T A R</u></b></div>
            <div id="displayedValues" style="text-align: center;">
