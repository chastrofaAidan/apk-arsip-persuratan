    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input class="custom-input" type="file" name="surat_keluar" id="surat_keluar" accept=".pdf"><br>
                    <label for="surat_keluar">Previous File: {{ $fileName }}</label><br>
                </div>
                <div class="col-md-6">
                    <input type="hidden" name="pembuatan_surat" id="pembuatan_surat" value="{{ $fileName }}">
                </div>
            </div>
        </div>
        <br>
