...
import java.util.List;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_b20);
            ...
            databaseReference = FirebaseDatabase.getInstance().getReference("Kelas B Angkatan 20");
            ...
            // Tambahkan tindakan saat tombol Floating Action Button diklik
