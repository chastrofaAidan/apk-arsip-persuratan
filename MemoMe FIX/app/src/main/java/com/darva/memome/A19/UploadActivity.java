...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    AutoCompleteTextView uploadTempat, uploadAbsen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_a19);
    ...
    public void saveData() {
        if (uri == null || uploadNisn.getText().toString().isEmpty() ||
            ...
            Toast.makeText(com.darva.memome.A19.UploadActivity.this, "Harap isi semua data sebelum menyimpan/upload.", Toast.LENGTH_SHORT).show();
    ...
    public void uploadData() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Kelas A Angkatan 19").push()
