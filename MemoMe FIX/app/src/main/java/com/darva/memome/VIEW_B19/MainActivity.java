package com.darva.memome.VIEW_B19;
...
import com.darva.memome.B19.UploadActivity;
...
import java.util.List;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_b19_view);
            ...
            databaseReference = FirebaseDatabase.getInstance().getReference("Kelas B Angkatan 19");
