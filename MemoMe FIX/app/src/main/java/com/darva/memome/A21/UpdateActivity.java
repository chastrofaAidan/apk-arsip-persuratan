...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    AutoCompleteTextView updateTempat, updateAbsen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_a21);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Kelas A Angkatan 21").child(key);
